...
public class PDFTextExtractor {
  ...
  private void extractPages(
      int startPage, int endPage, PDFTextStripper stripper, PDDocument document, Writer output) {
 ...
 * angle set is initialized. Source:
 * https://github.com/topobyte/pdfbox-tools/blob/master/src/main/java/org/apache/pdfbox/tools/ExtractText.java
 */
...
class FilteredTextStripper extends PDFTextStripper {
  ...
  private Map<Integer, List<TextPosition>> extractPositions(
      String word, List<TextPosition> textPositions) {
