...
public class Highlight {
  ...
  public PDAnnotation getAnnotation() {
    ...
    markup.setColor(
        new PDColor(new float[] {152 / 255F, 193 / 255F, 218 / 255F}, PDDeviceRGB.INSTANCE));
    return markup;
  }
